...
# Ayo's Personal Website


Technologies used so far:
1. [reactjs](http://reactjs.org) (and everything that comes with the create-react-app scaffolding)
2. [gh-pages](https://npmjs.com/package/gh-pages)
